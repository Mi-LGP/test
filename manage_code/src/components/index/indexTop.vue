  ...
  <div class="top_view">
      ...
      <el-dropdown class="avatar-container" trigger="hover">
        ...
        <template #dropdown>
          <el-dropdown-menu class="user-dropDown" slot="dropdown">
            <el-dropdown-item class="center" @click="centerClick"> 个人中心 </el-dropdown-item>
    ...
    <el-dialog v-model="recordVisible" :title="'聊天记录'" :append-to-body="true">
      <div class="z-box" :style="{ width: '70%', padding: '20px', margin: '0 auto' }">
        ...
        >
          <img
            :src="item.picture ? $config.url + item.picture : require('@/assets/img/avatar.png')"
...
import { toRefs, defineEmits, getCurrentInstance, ref, onBeforeUnmount, computed } from 'vue'
...
const hasChatList = ['yonghu', 'tuangoushangpin', 'shangpinxinxi', 'shangjia']
...
.top_right_view .actionBar .item:hover {
  color: #fff;
  cursor: pointer;
}
.top_right_view .actionBar .item i {
  font-size: 18px;
}
