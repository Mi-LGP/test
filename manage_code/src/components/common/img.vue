  ...
  <el-dialog title="拍照上传" v-model="visible" width="1065px">
    ...
    <template #footer>
      <div class="formModel_btn_box" style="display: flex">
        ...
        <el-button class="formModel_confirm" @click="drawImage" size="small"> 拍照 </el-button>
        ...
        <el-button class="formModel_confirm" @click="resetCanvas" size="small"> 重置 </el-button>
        <el-button class="formModel_cancel" @click="onCancel" size="small"> 完成 </el-button>
      </div>
    </template>
  </el-dialog>
</template>
