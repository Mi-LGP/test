					...
					<template #header>
						<div class="index_card_head">
							...
							<div class="card_head_right">
								<el-icon @click="countTypeClick('hiddennewsCountType')" class="showIcons"
				...
				<el-card v-show="countTypeList.closeshangpinxinxiCountType" class="card_view count-item">
					<template #header>
						<div class="index_card_head">
							...
							<div class="card_head_right">
								<el-icon @click="countTypeClick('hiddenshangpinxinxiCountType')" class="showIcons"
				...
				<el-card v-show="cardTypeList.closenewsChartType1" class="card_view chart-item">
					<template #header>
						<div class="index_card_head">
							...
							<div class="card_head_right">
								<el-icon @click="cardTypeClick('hiddennewsChartType1')" class="showIcons"
					...
					<el-collapse-transition>
						<div class="card_item" v-show="cardTypeList.hiddennewsChartType1">
							<div id="newsclickNumberEchart1" class="Echart" style="width: 100%;height: 400px;"></div>
						</div>
					</el-collapse-transition>
				</el-card>
			</el-collapse-transition>
...
<script setup>
	...
	const getnewsChart1 = () => {
		nextTick(()=>{
			var clickNumberEchart1 = echarts.init(document.getElementById("newsclickNumberEchart1"),'theme');
			context?.$http({
