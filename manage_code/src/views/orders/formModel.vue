				...
				<el-row >
					...
					<el-col :span="24">
						<el-form-item label="商户名称" prop="shangjia">
							<el-input class="list_inp" v-model="form.shangjia" placeholder="商户名称"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="团购编号" prop="groupno">
							<el-input class="list_inp" v-model="form.groupno" placeholder="团购编号"
                                type="text"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.logistics = res.data.data.logistics?(res.data.data.logistics.replace(reg,'../../../cl636300194/file')):'';
