<template>
  <div>
            ...
            <div v-if="r_index == role_index">
              <el-collapse v-model="collapse_default">
                <el-collapse-item v-for="(table, t_index) in role.backMenu" :name="table.menu">
                    ...
                    >
                      ...
                      <div style="padding-right: 30px">
                        ...
                        <el-button
                          size="small"
                          type="primary"
                          @click.stop="changeName(table, role.backMenu)"
                        >
                          修改菜单名
                        </el-button>
                      </div>
                  ...
                  >
                    <el-table-column prop="menu" label="菜单名" width="180"> </el-table-column>
                    <el-table-column label="权限">
                      <template #default="scope">
                        <el-checkbox-group v-model="scope.row.buttons">
                          <el-checkbox
                            v-for="item in scope.row.allButtons"
                            :label="item"
                            :value="item"
                          />
                        </el-checkbox-group>
                    ...
                    <el-table-column label="操作">
                      <template #default="scope">
                        ...
                        <el-button
                          size="small"
                          type="primary"
                          @click="changeName(scope.row, table.child)"
                        >
                          修改菜单名
                        </el-button>
                        <el-button
    ...
    <el-dialog title="修改父级菜单" v-model="dialogVisible" width="30%">
...
const moveTo = () => {
  let items = menus.value[role_index.value].backMenu[first_index.value].child.splice(
    o_index.value,
    1
  )
