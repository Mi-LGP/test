      ...
      <div class="list_search_view">
        <el-form :model="searchQuery" class="search_form">
          <div class="search_view">
            <div class="search_label">用户：</div>
            <div class="search_box">
              <el-input
                class="search_inp"
                v-model="searchQuery.yonghu"
                placeholder="用户"
                clearable
              >
              </el-input>
...
const getList = () => {
  ...
  params['sort'] = 'id'
  params['order'] = 'desc'
  if (searchQuery.value.yonghu && searchQuery.value.yonghu != '') {
    params['yonghu'] = '%' + searchQuery.value.yonghu + '%'
  }
  context
    .$http({
      url: `${tableName}/page`,
...
const exportClick = () => {
  import('@/utils/Export2Excel').then(excel => {
    const tHeader = ['用户', '密码', '姓名', '性别', '头像', '年龄', '余额']
    const filterVal = ['yonghu', 'mima', 'xingming', 'xingbie', 'touxiang', 'nianling', 'money']
