<template>
  <div>
        ...
        <el-form :model="searchQuery" class="search_form">
          <div class="search_view">
            ...
            <div class="search_box">
              <el-input class="search_inp" v-model="searchQuery.title" placeholder="标题" clearable>
              </el-input>
            </div>
          </div>
    ...
    <el-dialog v-model="echartVisible" title="统计图" width="70%">
      <div id="clickNumberEchart1" style="width: 100%; height: 600px"></div>
      <template #footer>
...
const echartClick1 = () => {
  ...
  nextTick(() => {
    var clickNumberEchart1 = echarts.init(document.getElementById('clickNumberEchart1'), 'theme')
    context
      .$http({
        url: `${tableName}/value/title/clickNumber?order=desc`,
        method: 'get',
      })
      .then(res => {
