    ...
    >
      <el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item prop="shangpintupian" label="商品图片">
              <uploads
...
const getInfo = () => {
  context
    ...
    .then(res => {
      ...
      res.data.data.shangpinxiangqing = res.data.data.shangpinxiangqing
        ? res.data.data.shangpinxiangqing.replace(reg, '../../../cl636300194/file')
        : ''
