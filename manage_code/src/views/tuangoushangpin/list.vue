<template>
  <div>
    <div class="center_view">
      ...
      <div class="dataList" v-if="btnAuth('tuangoushangpin', '查看')">
        <div class="item" v-for="(item, index) in list" :key="item.id">
          ...
          <div class="btns">
            ...
            <el-button
              ...
              v-if="btnAuth('tuangoushangpin', '修改')"
            >
              修改
            </el-button>
            <el-button
              ...
              v-if="btnAuth('tuangoushangpin', '删除')"
            >
              删除
            </el-button>
            <el-button
              class="cross_btn"
              v-if="btnAuth('tuangoushangpin', '配送')"
              type="success"
            ...
            <el-button
              class="operate_btn"
              v-if="btnAuth('tuangoushangpin', '查看评论')"
              type="warning"
