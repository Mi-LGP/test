			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="商品编号" prop="shangpinbianhao">
						<el-input class="list_inp" v-model="form.shangpinbianhao" placeholder="请输入商品编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.shangpinxiangqing = res.data.data.shangpinxiangqing.replace(reg,'../../../cl636300194/file');
