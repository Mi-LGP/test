	...
	<div>
		<div class="center_view">
			...
			<div class="list_search_view">
				...
				<div class="btn_view">
                    ...
                    <el-button class="statis_btn" type="warning" @click="echartClick1" v-if="btnAuth('orders'+(orderStatus?'/'+orderStatus:''),'月销量')">
                        <i class="iconfont icon-bar-chart--line"></i>
                        月销量
                    </el-button>
                    <el-button class="statis_btn" type="warning" @click="echartClick2" v-if="btnAuth('orders'+(orderStatus?'/'+orderStatus:''),'日销量')">
                        <i class="iconfont icon-bar-chart--line"></i>
                        日销量
                    </el-button>
				</div>
		...
		<el-dialog v-model="echartVisible" title="统计图" width="70%">
			<el-tabs v-model="echartActive" class="demo-tabs" @tab-change="echartTabClick" type="card">
                <el-tab-pane label="月销量" name="1" v-if="btnAuth('orders'+(orderStatus?'/'+orderStatus:''),'月销量')"></el-tab-pane>
                <el-tab-pane label="日销量" name="2" v-if="btnAuth('orders'+(orderStatus?'/'+orderStatus:''),'日销量')"></el-tab-pane>
			</el-tabs>
...
<script setup>
  ...
  if(
      ['未支付','已支付','已发货','已完成','已退款','已取消','拼团中']
          .includes(route.query.menuJump)
  ){
