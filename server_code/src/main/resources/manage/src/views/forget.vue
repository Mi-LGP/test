...
<style lang="scss" scoped>
	.forget_view {
        background-image: url("http://clfile.zggen.cn/20240915/0d51e630f6bb434c8a4f98d6f5fb78e3.webp")!important;
		// 表单盒子
		.forget_box {
			// 标题
			.forget_title {
...
.forget_view .list_item{  width: 100%; padding:0 10px; display: flex; align-items: center;   justify-content: flex-start;  margin: 0 0 20px; box-shadow:inset 0px -2px 6px 0px rgba(10,37,64,0.35), 0px 30px 60px -30px rgba(0,0,0,0.3), 0px 50px 100px -20px rgba(50,50,93,0.25);  }
...
.forget_view .list_btn{ margin-top:20px;  text-align:center;  }

.forget_view .list_btn .get_btn{ width: 100%; height: 46px; line-height: 46px; background:var(--theme); border: 0px solid #ccc; font-weight: 600; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:5px; }
.forget_view .list_btn .get_btn:hover {  }

.forget_view .list_btn .valid_btn{  width: 100%; height: 46px; line-height: 46px; background:var(--theme); border: 0px solid #ccc; font-weight: 600; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:5px; }
.forget_view .list_btn .valid_btn:hover {  }

.forget_view .list_btn .update_btn{  width: 100%; height: 46px; line-height: 46px; background:var(--theme); border: 0px solid #ccc; font-weight: 600; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:5px; }
.forget_view .list_btn .update_btn:hover {  }

.forget_view .list_btn .r-login{  font-size: 16px; color: #999;  }
.forget_view .list_btn .r-login:hover{ cursor:pointer; color: #1043a9;  }
