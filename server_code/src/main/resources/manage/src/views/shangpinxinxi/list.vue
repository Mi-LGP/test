<template>
	<div>
			...
			>
				<div class="item" v-for="(item,index) in list" :key="item.id">
					...
					<div class="btns">
						...
						<el-button class="cross_btn" v-if="btnAuth('shangpinxinxi','发布团购')" type="success" @click="tuangoushangpinCrossAddOrUpdateHandler(item,'cross','','','','')">
							发布团购
						</el-button>
						<el-button class="cross_btn" v-if="btnAuth('shangpinxinxi','配送')" type="success" @click="dingdanpeisongCrossAddOrUpdateHandler(item,'cross','','','','')">
							配送
						</el-button>
						<el-button class="operate_btn" v-if="btnAuth('shangpinxinxi','查看评论')" type="warning" @click="commentClick(item.id)">
							查看评论
						</el-button>
		...
		<tuangoushangpinFormModel ref="tuangoushangpinFormModelRef" @formModelChange="formModelChange"></tuangoushangpinFormModel>
...
<script setup>
	...
	import tuangoushangpinFormModel from '@/views/tuangoushangpin/formModel'
	const tuangoushangpinFormModelRef = ref(null)
    const tuangoushangpinCrossAddOrUpdateHandler = (row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue) => {
		...
		nextTick(()=>{
			tuangoushangpinFormModelRef.value.init(row.id,'cross','发布团购',row,'shangpinxinxi',statusColumnName,tips,statusColumnValue)
		})
    }
    ...
    const dingdanpeisongCrossAddOrUpdateHandler = (row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue) => {
		...
		nextTick(()=>{
			dingdanpeisongFormModelRef.value.init(row.id,'cross','配送',row,'shangpinxinxi',statusColumnName,tips,statusColumnValue)
		})
    }
