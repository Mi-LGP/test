	...
	<div>
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				<div class="title_view">基于SpribgBoot的社区团购系统登录</div>
...
<style lang="scss" scoped>
	.login_view {
        background-image: url("http://clfile.zggen.cn/20240915/33bf3b22566a41029322915a1133d80e.webp")!important;
		// 表单盒子
		.login_form {
		}
		.title_view {
...
.login_view {
    ...
    background-image: url(http://clfile.zggen.cn/20240910/72771594b3e8431880badf496191c7ce.jpg);
...
/*表单盒子*/
.login_form{ width:600px; margin:0 auto; padding:30px 50px 40px 50px; background:#fff; font-size:16px; border-radius:10px; transform:scale(1); -webkit-transform:scale(1); -ms-transform:scale(1); z-index:5; box-shadow:0px -3px 5px 0px rgba(0,0,0,0.09), 0px 12px 13px 0px rgba(0,0,0,0.17), 0px 4px 6px 0px rgba(0,0,0,0.12), 0px -12px 30px 0px rgba(0,0,0,0.12), 0px 54px 55px 0px rgba(0,0,0,0.25); }
...
/*list_item*/
.login_form .list_item{ width: 100%; padding:0 10px; display: flex; align-items: center;   justify-content: flex-start;  margin: 0 0 20px; box-shadow:inset 0px -2px 6px 0px rgba(10,37,64,0.35), 0px 30px 60px -30px rgba(0,0,0,0.3), 0px 50px 100px -20px rgba(50,50,93,0.25);  }
...
/*验证码*/
.login_form .listCode_view{ width: 100%; padding:0 0 0 10px; margin: 0 0 10px; display: flex; align-items: center;   justify-content: flex-start;  box-shadow:inset 0px -2px 6px 0px rgba(10,37,64,0.35), 0px 30px 60px -30px rgba(0,0,0,0.3), 0px 50px 100px -20px rgba(50,50,93,0.25);  }
...
.login_form .listCode_view .listCode_btn{ width:110px; background:var(--theme20); height:40px; line-height:40px; text-align:center; }
...
/* 按钮 */
.login_form .btn_view{   display: flex; flex-wrap:wrap;  justify-content: center;  }
.login_form .btn_view .login{ width: 100%; height: 46px; line-height: 46px; background: var(--theme); border: 0px solid #ccc; font-weight: 600; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:5px; }
.login_form .btn_view .login:hover {  }
.login_form .btn_view .register{ background: #fff; border: 2px solid #B8B8B8; font-size:16px; color: #666; margin:0 10px 10px 0;   }
.login_form .btn_view .register:hover {   }
.login_form .btn_view .forget{ margin: 0 0 10px; background: #fff; border:0px solid #ccc; font-size:16px; color: #666;  width: 100%;  text-align:center;  order:-1;  }
.login_form .btn_view .forget:hover {   }

.login_form .face{ width:100%; height: 50px; line-height:46px; background: #fff; border: 0px solid #ccc; font-weight: 500; font-size: 16px; color: #666; margin-bottom:10px; text-align:center; padding:0;  }
