	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">商家：</div>
					<el-input class="list_inp"
						 v-model="registerForm.shangjia" 
						 placeholder="请输入商家"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.shangjia)){
			context?.$toolUtil.message(`商家不能为空`,'error')
			return false
		}
...
<style lang="scss" scoped>
	...
	.register_view {
        background-image: url("http://clfile.zggen.cn/20240915/3824e709266a4c2d81dcaf82898bf41f.webp")!important;
		// 表单盒子
		.register_form {
		}
		// 标题样式
...
.register_form .list_item {  width: 100%; padding:0 10px; display: flex; align-items: center;   justify-content: flex-start;  margin: 0 0 20px; box-shadow:inset 0px -2px 6px 0px rgba(10,37,64,0.35), 0px 30px 60px -30px rgba(0,0,0,0.3), 0px 50px 100px -20px rgba(50,50,93,0.25); }
...
.register_form .list_code{  width: 100%; padding:0 0 0 10px; display: flex; align-items: center;   justify-content: flex-start;  margin: 0 0 20px; box-shadow:inset 0px -2px 6px 0px rgba(10,37,64,0.35), 0px 30px 60px -30px rgba(0,0,0,0.3), 0px 50px 100px -20px rgba(50,50,93,0.25);  }
...
.register_form .list_btn .register{ width: 100%; height: 46px; line-height: 46px; background: var(--theme); border: 0px solid #ccc; font-weight: 600; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:5px;  } 
