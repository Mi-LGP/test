...
public class TuangouActivityServiceImpl
    extends ServiceImpl<TuangouActivityDao, TuangouActivityEntity>
    implements TuangouActivityService {

  @Override
  public PageUtils queryPage(Map<String, Object> params) {
    Page<TuangouActivityEntity> page =
        this.selectPage(
