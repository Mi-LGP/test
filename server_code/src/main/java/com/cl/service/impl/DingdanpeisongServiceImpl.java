...
public class DingdanpeisongServiceImpl extends ServiceImpl<DingdanpeisongDao, DingdanpeisongEntity>
    implements DingdanpeisongService {

  @Override
  public PageUtils queryPage(Map<String, Object> params) {
    Page<DingdanpeisongEntity> page =
        this.selectPage(
