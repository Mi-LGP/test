...
public class ChatFriendServiceImpl extends ServiceImpl<ChatFriendDao, ChatFriendEntity>
    implements ChatFriendService {

  @Override
  public PageUtils queryPage(Map<String, Object> params) {
    Page<ChatFriendEntity> page =
        this.selectPage(
            new Query<ChatFriendEntity>(params).getPage(), new EntityWrapper<ChatFriendEntity>());
