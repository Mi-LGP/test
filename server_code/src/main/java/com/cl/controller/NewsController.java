...
public class NewsController {
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<NewsEntity> ew = new EntityWrapper<NewsEntity>();
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(newsService.selectTimeStatValue(params, ew));
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,NewsEntity news, HttpServletRequest request){
        EntityWrapper<NewsEntity> ew = new EntityWrapper<NewsEntity>();
        int count = newsService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, news), params), params));
