...
public class AddressController {
  ...
  @RequestMapping("/page")
  public R page(
      @RequestParam Map<String, Object> params, AddressEntity address, HttpServletRequest request) {
    ...
    PageUtils page =
        addressService.queryPage(
            params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, address), params), params));
  ...
  public R save(@RequestBody AddressEntity address, HttpServletRequest request) {
    ...
    if (address.getIsdefault().equals("是")) {
      addressService.updateForSet(
          "isdefault='否'", new EntityWrapper<AddressEntity>().eq("userid", userId));
    }
    ...
    if (address.getIsdefault().equals("是")) {
      addressService.updateForSet(
          ...
          new EntityWrapper<AddressEntity>()
              .eq("userid", request.getSession().getAttribute("userId")));
    }
