...
public class DiscussshangpinxinxiController {
  @Autowired private DiscussshangpinxinxiService discussshangpinxinxiService;

  /** 后台列表 */
  @RequestMapping("/page")
  public R page(
      @RequestParam Map<String, Object> params,
      DiscussshangpinxinxiEntity discussshangpinxinxi,
    ...
    PageUtils page =
        discussshangpinxinxiService.queryPage(
            params,
            MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussshangpinxinxi), params), params));
  ...
  public R info(@PathVariable("id") Long id) {
    ...
    discussshangpinxinxi =
        discussshangpinxinxiService.selectView(
            new EntityWrapper<DiscussshangpinxinxiEntity>().eq("id", id));
  ...
  @RequestMapping("/save")
  public R save(
      @RequestBody DiscussshangpinxinxiEntity discussshangpinxinxi, HttpServletRequest request) {
  ...
  public R security(@RequestParam String username) {
    DiscussshangpinxinxiEntity discussshangpinxinxi =
        discussshangpinxinxiService.selectOne(
            new EntityWrapper<DiscussshangpinxinxiEntity>().eq("", username));
    return R.ok().put("data", discussshangpinxinxi);
  }
