...
public class FileController {
  ...
  public R upload(@RequestParam("file") MultipartFile file, String type) throws Exception {
     ...
     */
    FileUtils.copyFile(dest, new File("D:\\ruoyi\\group_buying\\server_code\\src\\main\\resources\\static\\file"+"/"+fileName));
    // /**修改了路径以后请将该行最前面的//注释去掉**/
    if (StringUtils.isNotBlank(type) && type.equals("1")) {
      ConfigEntity configEntity =
          configService.selectOne(new EntityWrapper<ConfigEntity>().eq("name", "faceFile"));
