...
public class ShangjiaController {
  @Autowired private ShangjiaService shangjiaService;
  ...
  public R login(String username, String password, String captcha, HttpServletRequest request) {
    ShangjiaEntity u =
        shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("shangjia", username));
  ...
  public R register(@RequestBody ShangjiaEntity shangjia) {
    ...
    ShangjiaEntity u =
        shangjiaService.selectOne(
            new EntityWrapper<ShangjiaEntity>().eq("shangjia", shangjia.getShangjia()));
    if (u != null) {
  ...
  public R getCurrUser(HttpServletRequest request) {
    ...
    return R.ok()
        .put("data", shangjiaService.selectView(new EntityWrapper<ShangjiaEntity>().eq("id", id)));
  }
  ...
  public R page(
      ...
      ShangjiaEntity shangjia,
      HttpServletRequest request) {
    EntityWrapper<ShangjiaEntity> ew = new EntityWrapper<ShangjiaEntity>();

    PageUtils page =
        shangjiaService.queryPage(
            params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shangjia), params), params));
  ...
  public R save(@RequestBody ShangjiaEntity shangjia, HttpServletRequest request) {
    if (shangjiaService.selectCount(
            new EntityWrapper<ShangjiaEntity>().eq("shangjia", shangjia.getShangjia()))
        > 0) {
