...
public class TuangouActivityController {
    @Autowired
    private TuangouActivityService tuangouactivityService;
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TuangouActivityEntity tuangouactivity,
            HttpServletRequest request){
                    EntityWrapper<TuangouActivityEntity> ew = new EntityWrapper<TuangouActivityEntity>();
        
        PageUtils page = tuangouactivityService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, tuangouactivity), params), params));
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TuangouActivityEntity tuangouactivity,
		HttpServletRequest request){
        EntityWrapper<TuangouActivityEntity> ew = new EntityWrapper<TuangouActivityEntity>();
    ...
    public R list( TuangouActivityEntity tuangouactivity){
       	PageUtils page = tuangouactivityService.queryPage(new java.util.HashMap<>(), new EntityWrapper<TuangouActivityEntity>());
        return R.ok().put("data", page);
    }
    ...
    public R getByGroupono(@RequestParam String groupono){
        TuangouActivityEntity tuangouactivity = tuangouactivityService.selectOne(
