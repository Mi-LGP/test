...
public class MPUtil {
  ...
  public static List<Map<String, Object>> camelListToSnake(List<Map<String, Object>> camelList) {
    return camelList.stream().map(map -> camelMapToSnake(map)).collect(Collectors.toList());
  }
  ...
  public static List<Map<String, Object>> snakeListToCamel(List<Map<String, Object>> snakeList) {
    return snakeList.stream().map(map -> snakeMapToCamel(map)).collect(Collectors.toList());
  }
