  ...
  <el-dialog title="拍照上传" v-model="visible" width="1065px">
    ...
    <template #footer>
      <div style="display: flex; justify-content: flex-end">
        ...
        <el-button @click="drawImage" size="small"> 拍照 </el-button>
        <el-button v-if="os" @click="getCompetence" size="small"> 打开摄像头 </el-button>
        <el-button v-else @click="stopNavigator" size="small"> 关闭摄像头 </el-button>
        <el-button @click="resetCanvas" size="small"> 重置 </el-button>
        <el-button @click="onCancel" size="small"> 完成 </el-button>
      </div>
    </template>
  </el-dialog>
</template>
<script setup>
import { nextTick, ref, getCurrentInstance, computed, defineEmits } from 'vue'
