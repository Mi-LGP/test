...
.newsList_view {
  ...
  margin: 20px 0px 0;
  padding: 0 16% 120px;
  background: url(http://clfile.zggen.cn/20241219/92aae42c463d48bd947f23e977b6ede8.jpg) no-repeat
    center top / cover;
  overflow: hidden;
  position: relative;
  order: 5;
...
.newsList_view:before {
  ...
  width: 1100px;
  height: 92px;
  background: url(http://clfile.zggen.cn/20241219/9cf7afb259b14d2b87108552ea885a27.png) no-repeat
    center top;
  margin: 0 auto;
}
.newsList_view:after {
