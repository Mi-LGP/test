    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="btn_view">
          ...
          <el-button
            class="cross_btn"
            v-if="btnFrontAuth('shangpinxinxi', '发布团购')"
            @click="tuangoushangpinonAcross('发布团购', '', '', '', '')"
            type="warning"
            >发布团购</el-button
          >
          <el-button
            class="cross_btn"
            v-if="btnFrontAuth('shangpinxinxi', '配送')"
          ...
          <el-button
            class="edit_btn"
            v-if="centerType && btnAuth('shangpinxinxi', '修改')"
            type="primary"
            @click="editClick"
            >修改</el-button
          >
          <el-button
            class="del_btn"
            v-if="centerType && btnAuth('shangpinxinxi', '删除')"
            type="danger"
            @click="delClick"
            >删除</el-button
          >
...
const tuangoushangpinonAcross = async (
  btnType,
  crossOptAudit,
  crossOptPay,
  statusColumnName,
