...
const rules = ref({
  ...
  fid: [{ required: true, message: '请输入', trigger: 'blur' }],
  content: [],
  format: [{ validator: context.$toolUtil.validator.intNumber, trigger: 'blur' }],
  isRead: [{ validator: context.$toolUtil.validator.intNumber, trigger: 'blur' }],
})
//methods
