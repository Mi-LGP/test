...
.news-page .categorys{
    ...
    border:0px solid var(--theme-color50);
    order:2;
}
...
.news-page .news_list_one .list-item::before,.news-page .news_list_one .list-item::after {
    box-sizing: inherit;
    content: '';
    position: absolute;
    width: 100%;
...
.news-page .news_list_one .list-item::before {
...
.news-page .news_list_one .list-item::after {
...
.news-page .news_list_one .list-item:hover::before,.news-page .news_list_one .list-item:hover::after {
