        ...
        <el-col :span="12">
          <el-form-item label="配送状态" prop="peisongzhuangtai">
            <el-select
              ...
              style="width: 100%"
            >
              <el-option v-for="(item, index) in peisongzhuangtaiLists" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="配送员" prop="peisongyuan">
            <el-select
              ...
              style="width: 100%"
            >
              <el-option v-for="(item, index) in peisongyuanLists" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
...
//表单验证
const rules = ref({
  shangpinmingcheng: [{ required: true, message: '请输入', trigger: 'blur' }],
  yonghu: [],
  xingming: [],
  peisongzhuangtai: [],
  gengxinshijian: [],
...
const init = (
  ...
  context
    ...
    .then(res => {
      ...
      if (
        json.hasOwnProperty('shangpinmingcheng') &&
