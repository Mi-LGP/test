    ...
    <div class="usersView">
      ...
      <div class="usersBox updateInfo" v-if="tabIndex == 'center'">
        ...
        >
          <el-row>
            <el-col :span="24">
              <el-form-item prop="shangjia" label="商家">
                <el-input
                  class="list_inp"
                  v-model="userForm.shangjia"
                  placeholder="商家"
                  readonly
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="24">
              <el-form-item prop="shangjiamingcheng" label="商家名称">
                <el-input
                  class="list_inp"
                  v-model="userForm.shangjiamingcheng"
                  placeholder="商家名称"
                ></el-input>
              </el-form-item>
            </el-col>
...
//验证规则
const rules = ref({
  shangjia: [{ required: true, message: '请输入', trigger: 'blur' }],
  mima: [{ required: true, message: '请输入', trigger: 'blur' }],
  shangjiamingcheng: [{ required: true, message: '请输入', trigger: 'blur' }],
  xingbie: [],
  touxiang: [],
