	...
	<div>
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				<div class="list_item">
					<div class="list_label">用户：</div>
					<input class="list_inp"
					 v-model="registerForm.yonghu" 
					 placeholder="请输入用户"
					 type="text"
					 />
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.yonghu)){
			context?.$toolUtil.message(`用户不能为空`,'error')
			return false
		}
...
.register_view {
    min-height: 100vh;
    position: relative;
    background: url(http://clfile.zggen.cn/20250406/7c3e19862b3d411c90f20ddc5ce5e3b2.jpg) no-repeat center center / cover;
    display: flex;
